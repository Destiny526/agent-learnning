...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 z-50 h-full w-64 bg-white border-r border-gray-200 transition-transform lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        {/* Logo */}
        <div className="flex items-center gap-3 px-6 h-16 border-b border-gray-200">
          ...
          <div>
            <div className="text-lg font-bold text-gray-900">管理后台</div>
            <div className="text-xs text-gray-400">AI 行程助手</div>
          </div>
        </div>
      ...
      <div className="lg:ml-64">
        ...
        <header className="sticky top-0 z-30 bg-white border-b border-gray-200 h-16 flex items-center px-6">
          ...
          <h1 className="text-lg font-semibold text-gray-900">
            {NAV_ITEMS.find((n) => n.href === pathname)?.label || '管理后台'}
          </h1>
        </header>
